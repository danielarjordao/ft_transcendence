    ...
    <div ref={ref} style={{
      ...
      <div style={{ padding: '12px 16px', background: T.elevated, borderBottom: `1px solid ${T.border}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <button
          ...
          disabled={!hasUnread}
          style={{ color: hasUnread ? T.primary : T.dim, fontSize: 12, border: 'none', background: 'transparent', cursor: hasUnread ? 'pointer' : 'default', fontFamily: 'inherit' }}
        >
          Mark all as read
        </button>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          ...
          <div
            ...
            style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', borderRadius: 7, border: '1px solid transparent', color: T.dim, fontSize: 13, fontWeight: 500, cursor: 'pointer' }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = T.border; e.currentTarget.style.color = T.bright; }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = 'transparent'; e.currentTarget.style.color = T.dim; }}
          >
            <span>Friends</span>
          </div>
        </div>
